...
if __name__ == '__main__':
    ...
    # Move huge file by renaming it so the loader ignores it
    bad_file = r"d:\Proyecto2026\ACP_DWH\ACP Proyecciones\ETL\data\entrada\BI_Cosecha3_20260523_232732_20260525_093354.xlsx"
    desktop_dest = bad_file + ".bak"
    bad_file2 = r"d:\Proyecto2026\ACP_DWH\ACP Proyecciones\ETL\data\entrada\cosecha_sap\BI_Cosecha3.xlsx"
    desktop_dest2 = bad_file2 + ".bak"
    ...
    if os.path.exists(bad_file):
        ...
        moved = True
    if os.path.exists(bad_file2):
        os.rename(bad_file2, desktop_dest2)
        moved2 = True
    ...
    try:
        ...
        if moved2:
            os.rename(desktop_dest2, bad_file2)
