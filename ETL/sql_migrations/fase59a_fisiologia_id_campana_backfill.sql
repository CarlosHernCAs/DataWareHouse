-- =============================================================================
-- fase59a_fisiologia_id_campana_backfill.sql
-- =============================================================================
-- Objetivo:
--   Llevar Silver.Fact_Fisiologia al ecosistema Geografia-Campana.
...
-- 1. Auditoria pre-backfill
-- -----------------------------------------------------------------------------
PRINT '=== 1. Estado pre-backfill de Silver.Fact_Fisiologia ===';
SELECT
    Filas_Total         = COUNT(*),
...
PRINT CONCAT('fase59a: filas actualizadas = ', @upd);
GO
...
PRINT 'fase59a: backfill ID_Campana en Fact_Fisiologia completado.';
GO
