...
function Body<TSchema extends z.ZodType<FieldValues>>({
  ...
  const form = useForm<z.infer<TSchema>>({
    // zodResolver no preserva la firma genérica de TSchema en wrappers como
    // este: las sobrecargas exigen un ZodType concreto, no `extends`.
    // El cast aterriza el tipo al Output que ya inferimos con z.infer<TSchema>;
    // a runtime es idéntico.
