...
- Name: analyst-portal.spec.ts >> Portal Analista — smoke tests >> analista puede abrir el modal de nuevo widget
- Location: e2e\analyst-portal.spec.ts:75:7
...
Call log:
  - waiting for getByRole('button', { name: /editar layout/i })
