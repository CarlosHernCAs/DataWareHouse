...
- Name: analyst-portal.spec.ts >> Portal Analista — smoke tests >> analyst accede a /home y ve el workspace
- Location: e2e\analyst-portal.spec.ts:58:7
...
Locator: getByText('Mi Workspace')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Mi Workspace')
