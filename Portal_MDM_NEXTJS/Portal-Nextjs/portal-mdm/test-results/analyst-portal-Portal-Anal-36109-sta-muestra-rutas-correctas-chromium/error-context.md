...
- Name: analyst-portal.spec.ts >> Portal Analista — smoke tests >> sidebar del analista muestra rutas correctas
- Location: e2e\analyst-portal.spec.ts:66:7
...
Locator: getByRole('link', { name: /workspace/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /workspace/i })
