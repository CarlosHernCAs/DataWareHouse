...
test.describe("Módulo Analista", () => {
  ...
  test("el home del analista es /home", async ({ page }) => {
    await page.goto("/");
  ...
  test.skip("lista de modelos muestra catálogo de cards", async ({ page }) => {
  ...
  test.skip("detalle de modelo muestra tabs de métricas", async ({ page }) => {
  ...
  test("analista no puede acceder a /entities (redirige a /home)", async ({ page }) => {
